...
class UserPreferencesManager {
  ...
  toggleTheme(): UserPreferences['theme'] {
    const currentTheme = this.preferences.theme;
    const newTheme = currentTheme === 'light' ? 'dark' : 'light';
    return this.updatePreferences({ theme: newTheme }).theme;
  }

  toggleNotifications(): boolean {
    const newValue = !this.preferences.notifications;
    return this.updatePreferences({ notifications: newValue }).notifications;
  }
}
