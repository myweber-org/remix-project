...
class UserPreferencesManager {
    ...
    private validatePreferences(data: any): UserPreferences {
        ...
        return {
            ...
            notificationsEnabled: typeof data.notificationsEnabled === 'boolean' ? data.notificationsEnabled : UserPreferencesManager.DEFAULT_PREFERENCES.notificationsEnabled,
            fontSize: typeof data.fontSize === 'number' && data.fontSize >= 8 && data.fontSize <= 32 ? data.fontSize : UserPreferencesManager.DEFAULT_PREFERENCES.fontSize,
