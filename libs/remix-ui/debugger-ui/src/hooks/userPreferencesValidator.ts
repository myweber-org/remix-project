...
class UserPreferencesValidator {
  ...
  static validateStrict(preferences: UserPreferences): { isValid: boolean; errors: string[] } {
    const requiredFields: (keyof UserPreferences)[] = ['theme', 'notifications', 'language', 'fontSize', 'autoSave'];
