...
export const userPrefsManager = new UserPreferencesManager(defaultUserPreferences);typescript
interface UserPreferences {
  theme: 'light' | 'dark' | 'auto';
  language: string;
...
class UserPreferencesManager {
  ...
  private validatePreferences(data: any): UserPreferences {
    ...
    const language = typeof data.language === 'string' ? data.language : DEFAULT_PREFERENCES.language;
...
export const userPrefsManager = new UserPreferencesManager(defaultUserPreferences);import { z } from 'zod';
