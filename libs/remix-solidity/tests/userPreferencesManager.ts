...
export const userPreferences = new UserPreferencesManager();import { UserPreferences } from './types/user';
...
class UserPreferencesManager {
  ...
  private validatePreferences(data: unknown): UserPreferences {
    ...
    if ('itemsPerPage' in data && typeof data.itemsPerPage === 'number') {
      validated.itemsPerPage = Math.max(10, Math.min(100, data.itemsPerPage));
    }
