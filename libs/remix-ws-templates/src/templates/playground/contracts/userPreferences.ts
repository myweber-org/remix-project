...
class UserPreferencesService {
  ...
  static importFromJSON(jsonString: string): UserPreferencesService {
    try {
      const parsed = JSON.parse(jsonString);
      return new UserPreferencesService(parsed);
    } catch {
...
export { UserPreferencesService, type UserPreferences };