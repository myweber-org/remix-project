...
class PreferencesManager {
  ...
  hasUnsavedChanges(proposed: Partial<UserPreferences>): boolean {
    const merged = { ...this.preferences, ...proposed };
    return JSON.stringify(merged) !== JSON.stringify(this.preferences);
  }
}
