...
export { UserPreferencesManager, type UserPreferences };import { BehaviorSubject, Observable } from 'rxjs';
    ...
    window.addEventListener('storage', (event: StorageEvent) => {
      if (event.key === STORAGE_KEY && event.newValue) {
        try {
          ...
          console.warn('Failed to parse updated preferences from storage event');
        }
      }
    });
  }
