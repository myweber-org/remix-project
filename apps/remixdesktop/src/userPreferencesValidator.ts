...
function applyUserPreferences(preferences: Partial<UserPreferences>): void {
  try {
    const validated = UserPreferencesValidator.validate(preferences);
    console.log('Applying preferences:', validated);
    
    // Simulate applying preferences
...
export { UserPreferences, UserPreferencesValidator, PreferenceError, applyUserPreferences };