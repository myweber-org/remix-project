...
function createPreferenceManagerFromStorage(storageKey: string): UserPreferencesManager {
...
export { UserPreferencesManager, createPreferenceManagerFromStorage, type UserPreferences };interface UserPreferences {
  theme: 'light' | 'dark' | 'auto';
  notifications: boolean;
  language: string;
  fontSize: number;
