...
class UserPreferencesManager {
  ...
  hasValidPreferences(): boolean {
    ...
    return current.theme === defaultPrefs.theme &&
           current.language === defaultPrefs.language &&
           current.notificationsEnabled === defaultPrefs.notificationsEnabled &&
           current.fontSize === defaultPrefs.fontSize;
  }
}
